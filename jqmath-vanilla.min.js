...
else if(o){if(/^[∛∜]$/.test(n)&&!t[2])return s=l("mn",'∛'==n?"3":"4"),[l("msup",[l("mo","v"),s]),"v"]
...
M.appendChild(g),M.style.whiteSpace="nowrap",v=M}l.push(v),m.lastIndex=p+f.length}}$.iter(function(e){t.parentNode.insertBefore(e,t)},l),t.parentNode.removeChild(t)}},e.parseMathQ=!0,"complete"===document.readyState||document.readyState&&"loading"!==document.readyState&&!document.documentElement.doScroll?D():document.addEventListener("DOMContentLoaded",D,!1),e}(),M
void 0===M&&(M=jqMath)
